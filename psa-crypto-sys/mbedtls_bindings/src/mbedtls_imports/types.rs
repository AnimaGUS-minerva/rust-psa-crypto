...
#[cfg(all(unix, any(std_component = "fs", feature = "mbedtls-fs-workaround")))]
...
cfg_if! {
    ...
    } else if #[cfg(all(unix, any(time_component = "libc", feature = "mbedtls-time-workaround")))] {
...
pub type psa_hash_operation_s = u8; // kludge: FIXME
